...
dump_jsonl_data(mixed_data, 'outputs/MathR-32B-Distill-Qwen2.5-7B-Instruct.jsonl')
...
task_cfg = TaskConfig(
    model='MathR-32B-Distill-Qwen2.5-7B-Instruct',
    ...
    dataset_args={
        'data_collection': {
            'local_path': 'outputs/MathR-32B-Distill-Qwen2.5-7B-Instruct.jsonl'
        }
    },
    eval_batch_size=16,
